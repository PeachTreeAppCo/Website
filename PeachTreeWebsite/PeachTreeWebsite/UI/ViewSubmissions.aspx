<%@ Page Title="" Language="C#" MasterPageFile="~/LoggedIn.Master" AutoEventWireup="true" CodeBehind="ViewSubmissions.aspx.cs" Inherits="PeachTreeWebsite.UI.ViewSubmissions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:GridView ID="gridviewSubmissions" OnRowCommand="GridView1_RowCommand" runat="server" CssClass="gv" CellPadding="10" AllowSorting="True">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
